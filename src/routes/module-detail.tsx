    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Module not found</h1>
          <p className="text-gray-600 mb-8">The module you're looking for doesn't exist.</p>
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-gray-50 to-white py-16 lg:py-24">
        <div className="container-x">
          <Link to="/modules" className="text-purple-600 hover:text-purple-700 font-semibold mb-6 inline-flex items-center gap-1">
            ← Back to modules
          </Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-3 bg-gray-100 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm font-semibold text-gray-700">{module.category}</span>
              </div>

              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6">{module.name}</h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">{module.longDescription}</p>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                ...
                <button className="inline-flex items-center gap-2 border-2 border-gray-300 text-gray-900 font-semibold py-3 px-8 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition">
                  Schedule demo
                </button>
              </div>
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container-x">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-12">Key Features</h2>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container-x">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-12">Use Cases</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="border border-gray-200 rounded-xl p-8 hover:shadow-lg transition">
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container-x">
          <div className="max-w-3xl">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">Built for Integration</h2>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-8">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Integration Options</h3>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container-x">
          <div className="bg-gradient-to-r from-purple-600 to-purple-700 rounded-2xl p-12 lg:p-16 text-white text-center">
            ...
            <Link
              to="/login"
              className="inline-flex items-center gap-2 bg-white text-purple-600 font-semibold py-3 px-8 rounded-lg hover:bg-gray-100 transition"
            >
